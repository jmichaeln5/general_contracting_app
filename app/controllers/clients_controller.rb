class ClientsController < ApplicationController
  ...
  private
    ...
    def client_params
      ...
      params.require(:client).permit(:name, :phone_number, :email, :type_of_project, :payment_method, :description, :latitude, :longitude, :address, :city, :state, :zip, :link, :user_id)
    end
end
